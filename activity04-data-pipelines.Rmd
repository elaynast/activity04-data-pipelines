...
**Response**: It showed the attaching packages and conflicts from the output
...
**Response**: Shows the same message as the conosle which isn't really important right now.
...
**Response**: I would order the unemployment rate by highest using desc() and also gorup it by major
...
**Response**: Early childhood education was listed as the highest women major
...
**Response**: The output produced five majors from the stem major category that make a median salary under 36,000
